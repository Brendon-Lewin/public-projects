...
This will allow school leaders to identify which buckets different subjects have contributed to.
Then, this data has been used to identify the number of times each subject is not included in the attainment 8 buckets, and therefore did not contribute towards the school's A8 and P8 figures.
...
NB: The candidate number column has been removed for GDPR reasons and the output has been truncated for readability
